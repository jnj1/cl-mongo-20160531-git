			 ...
			 (let ((doc (make-document)))
			   ...
			   (let ((doc2 (make-document)))
			     ...
			     (let ((doc3 (make-document)))
			       ...
			       (add-element "doc2" doc2 doc)))
			   (let ((doc4 (make-document))
				 (doc5 (make-document))
				 (doc6 (make-document))
				 (a nil))
			     (add-element "key-1" "doc in doc !!" doc4)
			     (add-element "key-2" 56.89 doc4)
			     (add-element "key-1" "doc in doc !!" doc5)
			     (add-element "key-2" 56.89 doc5)
			     (add-element "key-1" "doc in doc !!" doc6)
			     (add-element "key-2" 56.89 doc6)
			     (setf a (list doc4 doc5 doc6))
			     (add-element "doc-array" a doc))
			   (db.insert collection doc ))))

#|
(send-doc-in-doc-in-doc "foo")
|#
